...
ANaveEnemigaAbastecimiento::ANaveEnemigaAbastecimiento()
{
...
void ANaveEnemigaAbastecimiento::NotifyActorBeginOverlap(AActor* OtherActor)
{
}

void ANaveEnemigaAbastecimiento::Componente_Destruccion()
{
}

void ANaveEnemigaAbastecimiento::Recibir_Danio(float Danio)
{
}

void ANaveEnemigaAbastecimiento::Movimiento_Nave(float DeltaTime)
{
...
void ANaveEnemigaAbastecimiento::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
	Movimiento_Nave(DeltaTime);
}

void ANaveEnemigaAbastecimiento::BeginPlay()
{
	Super::BeginPlay();
}
