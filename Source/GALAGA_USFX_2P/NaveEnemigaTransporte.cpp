...
void ANaveEnemigaTransporte::NotifyActorBeginOverlap(AActor* OtherActor)
{
}

void ANaveEnemigaTransporte::Componente_Destruccion()
{
}

void ANaveEnemigaTransporte::Recibir_Danio(float Danio)
{
}

void ANaveEnemigaTransporte::Movimiento_Nave(float DeltaTime)
{
